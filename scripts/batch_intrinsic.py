...
BATCH_SUMMARY_COLUMNS = [
    ...
    "max_firing_rate_hz",
    "fi_slope_hz_per_pA",
    "current_at_max_firing_pA",
    "dep_block_current_pA",
    "spikes_csv",
    "summary_json",
    "status",
]
...
def process_cell(row: pd.Series, file_column: str, out_dir: Path, args) -> dict:
    ...
    status_row.update({
        ...
        "current_at_max_firing_pA": fi_cell_level.get("current_at_max_firing_pA", ""),
        "dep_block_current_pA": fi_cell_level.get("dep_block_current_pA", ""),
